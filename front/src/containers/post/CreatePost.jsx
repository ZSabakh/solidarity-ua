...
import { Card, CardContent, Box, TextField, Autocomplete, Checkbox, Button } from "@mui/material";
          ...
          <Box className={classes.box} component="form" onSubmit={handleFormSubmit}>
            ...
            <form onChange={handleGeneralFormChange}>
              ...
              <Box>
                ...
                <TextField name="contact.email.value" onChange={handleFormChange} onChange={handleFormChange} label="Email" />
                <Checkbox name="contact.email.public" onChange={(event) => handleFormChange(event, "check")} defaultChecked />
                <TextField name="contact.telegram.value" onChange={(event) => handleFormChange(event, "check")} onChange={handleFormChange} label="Telegram" />
                <Checkbox name="contact.email.telegram" onChange={(event) => handleFormChange(event, "check")} defaultChecked />
                <TextField name="contact.whatsapp.value" onChange={(event) => handleFormChange(event, "check")} onChange={handleFormChange} label="Whatsapp" />
                <Checkbox name="contact.email.whatsapp" onChange={(event) => handleFormChange(event, "check")} defaultChecked />
                <TextField name="contact.viber.value" onChange={(event) => handleFormChange(event, "check")} onChange={handleFormChange} label="Viber" />
                <Checkbox name="contact.email.viber" onChange={(event) => handleFormChange(event, "check")} defaultChecked />
              </Box>
            </form>
