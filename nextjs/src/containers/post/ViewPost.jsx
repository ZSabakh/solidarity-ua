...
import CarIcon from "../../resources/images/car-solid.svg";
import BuildingIcon from "../../resources/images/building-solid.svg";
import OtherIcon from "../../resources/images/star-of-life-solid.svg";
...
export default function ViewPost() {
  ...
  const PostIcon = () => {
    if (post.type?.name?.en === "Transportation") {
      return <CarIcon width={35} height={35} />;
    } else if (post.type?.name?.en === "Accomodation") {
      return <BuildingIcon width={35} height={35} />;
    } else {
      return <OtherIcon width={35} height={35} />;
    }
  };
            ...
            <div className="container support_general_info">
              ...
              <Box>
                ...
                <Grid container md={8} xs={12}>
                  ...
                  {post.mapa ? (
                    <i>
                      *Post has been fetched from{" "}
                      <a href="https://mapahelp.me/">MAPAHELP</a>
                    </i>
                  ) : null}
                </Grid>
